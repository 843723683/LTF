...
test1(){
	pathchk -p "<>"
	TestRetParse_LTFLIB "pathchk -p \"<>\"" "true" "yes"
}
...
test2(){
	...
	TestRetParse_LTFLIB "pathchk " "true" "yes"
}
...
test3(){
	...
	TestRetParse_LTFLIB "pathchk /var/tmp"
}
